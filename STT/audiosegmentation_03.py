...
'''오디오 파일을 불러옴 > silence 부분마다 잘라서 음성 파일 저장 > 해당 파일을 google stt에 적용 > 한글 맞춤법 검사 > text 출력'''

# file_list = ['E:\\nmb\\nmb_data\\predict\\stt\\test_01.wav',
#              'E:\\nmb\\nmb_data\\predict\\stt\\test_02.wav',
#              'E:\\nmb\\nmb_data\\predict\\stt\\F37.wav',
#              'E:\\nmb\\nmb_data\\predict\\stt\\M41.wav',
#              'E:\\nmb\\nmb_data\\predict\\stt\\M37.wav',
#              'E:\\nmb\\nmb_data\\predict\\stt\\M36.wav']

file_list = librosa.util.find_files('E:\\nmb\\nmb_data\\predict\\stt_denoise\\', ext=['wav'])
print(file_list)
...
for j, path in enumerate(file_list) : 
    ...
    for i, chunk in enumerate(audio_chunks):
        ...
        out_file = "E:\\nmb\\nmb_data\\chunk\\chunk_denoise\\"+ str(j) + f"chunk{i}.wav"
