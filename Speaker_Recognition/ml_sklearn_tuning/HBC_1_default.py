...
# model & weight save
pickle.dump(model, open('C:\\nmb\\nmb_data\\cp\\5s_last_0510_ml\\HBC_1_default.data', 'wb')) # wb : write
print("== save complete ==")

# model load
# model = pickle.load(open('C:\\nmb\\nmb_data\\cp\\5s_last_0510_ml\\HBC_1_default.data', 'rb'))  # rb : read
# time >>  
...
'''
log_loss :       2.6627144629362287
accuracy :       0.9229074889867841
