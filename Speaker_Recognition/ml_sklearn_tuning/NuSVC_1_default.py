...
# model & weight save
pickle.dump(model, open('E:\\nmb\\nmb_data\\cp\\5s_last_0510_ml\\NuSVC_1_default.data', 'wb')) # wb : write
print("== save complete ==")

# model load
# model = pickle.load(open('E:\\nmb\\nmb_data\\cp\\5s_last_0510_ml\\NuSVC_1_default.data', 'rb'))  # rb : read
# time >>  
...
'''
..*.*
optimization finished, #iter = 3892
obj = -795.985450, rho = -0.991326
nSV = 1894, nBSV = 0
Total nSV = 1894
[LibSVM]== save complete ==
accuracy :       0.9592511013215859
log_loss :       1.4074329508429952
