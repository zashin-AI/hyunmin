...
# 모델 구성
model = GradientBoostingClassifier(verbose=1, random_state=42, n_estimators=200)
model.fit(x_train, y_train)

# model & weight save
pickle.dump(model, open('E:\\nmb\\nmb_data\\cp\\5s_last_0510_ml\\GBC_7_epoch200.data', 'wb')) # wb : write
print("== save complete ==")

# model load
# model = pickle.load(open('E:\\nmb\\nmb_data\\cp\\5s_last_0510_ml\\GBC_7_epoch200.data', 'rb'))  # rb : read
# time >>  
