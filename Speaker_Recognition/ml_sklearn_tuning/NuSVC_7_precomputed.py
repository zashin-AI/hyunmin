...
# 모델 구성
model = NuSVC(verbose=1, random_state=42, kernel='precomputed')
model.fit(x_train, y_train)

# model & weight save
pickle.dump(model, open('E:\\nmb\\nmb_data\\cp\\5s_last_0510_ml\\NuSVC_7_precomputed.data', 'wb')) # wb : write
print("== save complete ==")
 
# model load
# model = pickle.load(open('E:\\nmb\\nmb_data\\cp\\5s_last_0510_ml\\NuSVC_7_precomputed.data', 'rb'))  # rb : read
# time >>  
...
Traceback (most recent call last):
  File "e:\nmb\nada\Speaker_Recognition\ml_sklearn_tuning\NuSVC_7_precomputed.py", line 48, in <module>
    model.fit(x_train, y_train)
  File "C:\Users\nammr\anaconda3\envs\pj21\lib\site-packages\sklearn\svm\_base.py", line 181, in fit
    .format(X.shape[0], X.shape[1]))
ValueError: Precomputed matrix must be a square matrix. Input is a 3628x110336 matrix.
'''