...
# 모델 구성
model = NuSVC(verbose=1, random_state=42, kernel='poly')
model.fit(x_train, y_train)

# model & weight save
pickle.dump(model, open('E:\\nmb\\nmb_data\\cp\\5s_last_0510_ml\\NuSVC_6_poly.data', 'wb')) # wb : write
print("== save complete ==")
 
# model load
# model = pickle.load(open('E:\\nmb\\nmb_data\\cp\\5s_last_0510_ml\\NuSVC_6_poly.data', 'rb'))  # rb : read
# time >>  
...
'''
optimization finished, #iter = 113310
C = 5.459281
obj = 3642.865151, rho = -0.247029
nSV = 3523, nBSV = 1071
Total nSV = 3523
[LibSVM]== save complete ==
log_loss :       9.24331306293536
