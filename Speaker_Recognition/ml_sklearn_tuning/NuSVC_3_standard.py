...
# 모델 구성
model = NuSVC(verbose=1, random_state=42)
model.fit(x_train, y_train)

# model & weight save
pickle.dump(model, open('E:\\nmb\\nmb_data\\cp\\5s_last_0510_ml\\NuSVC_3_standard.data', 'wb')) # wb : write
print("== save complete ==")

# model load
# model = pickle.load(open('E:\\nmb\\nmb_data\\cp\\5s_last_0510_ml\\NuSVC_3_standard.data', 'rb'))  # rb : read
# time >>  
...
log_loss :       2.3203521507084757
accuracy :       0.9328193832599119
