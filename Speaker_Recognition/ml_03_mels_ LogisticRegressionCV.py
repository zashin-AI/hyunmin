...
# model & weight save
pickle.dump(model, open('E:/nmb/nmb_data/cp/m03_mels_LogisticRegressionCV5.data', 'wb')) # wb : write
# pickle.dump(model, open('E:/nmb/nmb_data/cp/m03_mels_LogisticRegressionCV8.data', 'wb')) # wb : write
print("== save complete ==")
