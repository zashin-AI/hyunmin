...
# 모델 구성
model = SVC(verbose=1, C=1)
model.fit(x_train, y_train)

# model & weight save
pickle.dump(model, open('E:/nmb/nmb_data/cp/svc/svc_C1_standard.data', 'wb')) # wb : write
# print("== save complete ==")
...
obj = -720.074424, rho = -0.449811
nSV = 1991, nBSV = 529
Total nSV = 1991
hamming_loss :   0.06901041666666667
hinge_loss :     0.59765625
log_loss :       2.383552008449414
accuracy :       0.9309895833333334
recall :         0.8977900552486188
precision :      0.9530791788856305
f1 :     0.9246088193456614
