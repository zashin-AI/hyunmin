...
# model & weight save
pickle.dump(model, open('E:/nmb/nmb_data/cp/svc/svc_linear.data', 'wb')) # wb : write
# print("== save complete ==")
...
obj = -0.000144, rho = -1.814160
nSV = 1155, nBSV = 0
Total nSV = 1155
hamming_loss :   0.10416666666666667
hinge_loss :     0.6328125
log_loss :       3.597830853502686
