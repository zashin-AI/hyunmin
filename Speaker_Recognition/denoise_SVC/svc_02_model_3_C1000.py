...
# 모델 구성
model = SVC(verbose=1, C=1000)
model.fit(x_train, y_train)

# model & weight save
pickle.dump(model, open('E:/nmb/nmb_data/cp/svc/svc_C1000.data', 'wb')) # wb : write
# print("== save complete ==")

# model load
# model = pickle.load(open('E:/nmb/nmb_data/cp/svc/svc_linear.data', 'rb'))  # rb : read
# time >> 
...
obj = -921.966686, rho = -1.430357
nSV = 1825, nBSV = 0
Total nSV = 1825
hamming_loss :   0.06640625
hinge_loss :     0.5950520833333334
log_loss :       2.293609360539308
accuracy :       0.93359375
recall :         0.9088397790055248
precision :      0.9481268011527377
f1 :     0.928067700987306
