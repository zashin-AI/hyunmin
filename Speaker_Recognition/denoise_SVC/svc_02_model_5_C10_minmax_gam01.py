...
# 모델 구성
model = SVC(verbose=1, C=10, random_state=42, gamma=0.1)
model.fit(x_train, y_train)

# model & weight save
pickle.dump(model, open('E:/nmb/nmb_data/cp/svc/svc_C10_gam01.data', 'wb')) # wb : write
# print("== save complete ==")
...
'''
[LibSVM].....*..*
optimization finished, #iter = 7788
obj = -1528.449612, rho = 0.018967
nSV = 3058, nBSV = 0
Total nSV = 3058
