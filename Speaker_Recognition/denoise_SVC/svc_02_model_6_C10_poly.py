...
# 모델 구성
model = SVC(verbose=1, C=10, random_state=42, kernel='poly')
model.fit(x_train, y_train)

# model & weight save
pickle.dump(model, open('E:/nmb/nmb_data/cp/svc/svc_C10_poly.data', 'wb')) # wb : write
# print("== save complete ==")
...
'''
[LibSVM]..*.*
optimization finished, #iter = 3512
obj = -1605.352954, rho = -0.395597
nSV = 1592, nBSV = 63
Total nSV = 1592
hamming_loss :   0.09635416666666667
hinge_loss :     0.625
log_loss :       3.3279820869226246
