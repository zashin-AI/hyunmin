...
# 모델 구성
model = SVC(verbose=1, C=0.1)
# model.fit(x_train, y_train)

# model & weight save
# pickle.dump(model, open('E:/nmb/nmb_data/cp/svc/svc_C01.data', 'wb')) # wb : write
# print("== save complete ==")

# model load
model = pickle.load(open('E:/nmb/nmb_data/cp/svc/svc_C01.data', 'rb'))  # rb : read
# time >> 
...
obj = -169.710001, rho = -0.028284
nSV = 2288, nBSV = 2124
Total nSV = 2288
hamming_loss :   0.15234375
hinge_loss :     0.6809895833333334
log_loss :       5.2618156501090745
accuracy :       0.84765625
recall :         0.8066298342541437
precision :      0.8613569321533924
f1 :     0.8330955777460771
...
E:\nmb\nmb_data\predict\M\M10.wav 여자입니다.
...
E:\nmb\nmb_data\predict\M\M2_high.wav 여자입니다.
...
E:\nmb\nmb_data\predict\M\M35.wav 여자입니다.
