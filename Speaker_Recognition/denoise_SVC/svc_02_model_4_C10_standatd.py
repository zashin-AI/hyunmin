...
# 모델 구성
model = SVC(verbose=1, C=10)
# model.fit(x_train, y_train)

# model & weight save
# pickle.dump(model, open('E:/nmb/nmb_data/cp/svc/svc_C10_standard.data', 'wb')) # wb : write
# print("== save complete ==")
...
'''
[LibSVM]..*.*
optimization finished, #iter = 3820
obj = -880.015581, rho = -0.470570
nSV = 1988, nBSV = 1
Total nSV = 1988
hamming_loss :   0.05859375
hinge_loss :     0.5872395833333334
log_loss :       2.023773087669094
accuracy :       0.94140625
recall :         0.919889502762431
precision :      0.9541547277936963
...
E:\nmb\nmb_data\predict\M\M2_low.wav 여자입니다.
...
E:\nmb\nmb_data\predict\M\M38.wav 여자입니다.
...
E:\nmb\nmb_data\predict\M\M5_low.wav 여자입니다.
...
47개 여성 목소리 중 42개 정답입니다.
48개 남성 목소리 중 35개 정답입니다.
time >>  0:13:21.236549
'''