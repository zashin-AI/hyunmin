...
# model & weight save
# pickle.dump(model, open('E:/nmb/nmb_data/cp/svc/svc_base.data', 'wb')) # wb : write
# print("== save complete ==")

# model load
model = pickle.load(open('E:/nmb/nmb_data/cp/svc/svc_base.data', 'rb'))  # rb : read
# time >> 
...
hamming_loss :   0.08203125
hinge_loss :     0.6106770833333334
log_loss :       2.833278782852275
