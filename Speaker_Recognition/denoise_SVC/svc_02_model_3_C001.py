...
# 모델 구성
model = SVC(verbose=1, C=0.01)
# model.fit(x_train, y_train)

# model & weight save
# pickle.dump(model, open('E:/nmb/nmb_data/cp/svc/svc_C001.data', 'wb')) # wb : write
# print("== save complete ==")

# model load
model = pickle.load(open('E:/nmb/nmb_data/cp/svc/svc_C001.data', 'rb'))  # rb : read
# time >> 
...
obj = -27.839870, rho = 0.773398
nSV = 3033, nBSV = 3024
Total nSV = 3033
hamming_loss :   0.5182291666666666
hinge_loss :     1.046875
log_loss :       17.89941568353082
