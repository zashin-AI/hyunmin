...
# 모델 구성
model = SVC(verbose=1, C=0.001)
model.fit(x_train, y_train)

# model & weight save
pickle.dump(model, open('E:/nmb/nmb_data/cp/svc/svc_C0001.data', 'wb')) # wb : write
# print("== save complete ==")
...
obj = -3.003598, rho = 0.977536
nSV = 3030, nBSV = 3026
Total nSV = 3030
hamming_loss :   0.5286458333333334
hinge_loss :     1.0572916666666667
log_loss :       18.25920293345104
accuracy :       0.4713541666666667
recall :         1.0
precision :      0.4713541666666667
f1 :     0.6407079646017699
