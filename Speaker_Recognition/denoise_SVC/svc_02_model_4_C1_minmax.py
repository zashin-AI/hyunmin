...
# model & weight save
pickle.dump(model, open('E:/nmb/nmb_data/cp/svc/svc_C1_minmax.data', 'wb')) # wb : write
# print("== save complete ==")
...
'''
[LibSVM].*.*
optimization finished, #iter = 2485
obj = -677.485020, rho = -1.031470
nSV = 1770, nBSV = 595
Total nSV = 1770
hamming_loss :   0.07552083333333333
hinge_loss :     0.6041666666666666
log_loss :       2.608414875079601
